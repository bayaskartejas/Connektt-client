...
import { mockInfluencers, Influencer } from '@/lib/mock-data';
...
function BookingContent() {
  ...
  useEffect(() => {
    ...
    if (influencerId) {
      const foundInfluencer = mockInfluencers.find(inf => inf.id === influencerId);
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-sm">{influencer.profession}</p>
